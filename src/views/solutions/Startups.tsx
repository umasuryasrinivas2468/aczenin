        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {fundingOptions.map((option, index) => (
              <Card key={index} className="rounded-2xl shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-2xl shadow-soft p-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-foreground">500+ Startups Funded</div>
                    <div className="text-sm text-muted-foreground">₹250Cr+ Disbursed</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <Card key={index} className="rounded-2xl shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Founder, {testimonial.company}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
