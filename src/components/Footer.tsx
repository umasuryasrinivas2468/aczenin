...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative m-4 md:m-8 h-fit overflow-hidden rounded-3xl border border-smebank-100 bg-white/70 text-gray-600 shadow-[0_18px_50px_-24px_rgba(15,40,70,0.25)]">
        <div className="relative z-40 mx-auto max-w-7xl p-8 md:p-14">
          ...
          <motion.div
            ...
            className="mb-12 grid grid-cols-1 items-center gap-6 rounded-2xl border border-smebank-100 bg-gradient-to-r from-smebank-50 via-smeteal-50/60 to-white p-6 md:grid-cols-2 md:p-8"
          >
            <div>
              ...
              {subscribed ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="flex shrink-0 items-center gap-1.5 rounded-xl bg-gradient-to-r from-smebank-700 to-smeteal-600 px-5 py-3 text-sm font-medium text-white transition-all hover:shadow-soft hover:scale-[1.02]"
                  >
                    Subscribe
