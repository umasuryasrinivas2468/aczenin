      ...
      <main className="pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-muted-foreground">/</span>
            <span className="text-foreground">Aczen OS</span>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-smebank-100 rounded-xl flex items-center justify-center mr-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  className="bg-gradient-to-r from-smebank-600 to-smebank-700 text-white px-8 py-3 rounded-xl font-medium shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 flex items-center justify-center"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="border border-smebank-600 text-smebank-600 hover:bg-smebank-50 px-8 py-3 rounded-xl font-medium text-center"
                >
                  Schedule Demo
                </a>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Revolutionary Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="feature-card">
                <div className="w-12 h-12 bg-smebank-100 rounded-xl flex items-center justify-center mb-4">
        ...
        {/* System Requirements */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-gradient-to-r from-smebank-50 to-smeteal-50 rounded-3xl p-8 md:p-12">
            <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-2xl shadow-soft">
                <h3 className="text-xl font-bold text-foreground mb-4">Minimum Requirements</h3>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-soft border-2 border-smebank-200">
                <h3 className="text-xl font-bold text-foreground mb-4">Recommended</h3>
                <ul className="space-y-3">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Device Compatibility</h2>
            <p className="text-lg text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-2xl shadow-soft border text-center">
                ...
                <h3 className="font-bold text-foreground mb-2">{device.name}</h3>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-smebank-600 to-smeteal-600 rounded-3xl p-8 md:p-12 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-white text-smebank-600 px-8 py-3 rounded-xl font-semibold shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center"
              >
                <Monitor className="w-4 h-4 mr-2" />
                Try Web OS
              </a>
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="border border-white text-white hover:bg-white hover:text-smebank-600 px-8 py-3 rounded-xl font-medium transition-colors text-center"
              >
                Schedule Demo
              </a>
            </div>
