  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-24 pb-16">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  className="bg-gradient-to-r from-smebank-600 to-smebank-700 text-white px-8 py-3 rounded-md font-medium hover:shadow-lg transition-all duration-300 flex items-center justify-center"
                >
        ...
        {/* System Requirements */}
        <section className="container mx-auto px-4 mb-16">
          <div className="bg-gradient-to-r from-smebank-50 to-smebank-50 rounded-xl p-8 md:p-12">
            <div className="text-center mb-12">
        ...
        <section className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-smebank-600 to-smebank-600 rounded-xl p-8 md:p-12 text-center text-white">
