...
const testimonials: Testimonial[] = [
  {
    ...
    initials: "NV",
    accent: "from-smebank-500 to-blue-500",
    quote:
  ...
  },
  {
    ...
    initials: "EG",
    accent: "from-fuchsia-500 to-smebank-500",
    quote:
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight">
            Real teams.{" "}
            <span className="bg-gradient-to-r from-blue-600 via-smebank-600 to-fuchsia-600 bg-clip-text text-transparent">
              Real results.
            </span>
          </h2>
