        ...
        <main className="pt-24 pb-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
            <nav aria-label="Breadcrumb" className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-foreground">Business Banking</span>
            </nav>
          </div>
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/start"
                  className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-xl font-semibold shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 flex items-center justify-center"
                >
                ...
                <a
                  ...
                  className="border border-indigo-600 text-indigo-700 hover:bg-indigo-50 px-8 py-3 rounded-xl font-medium text-center"
                >
                  Book a Demo
                </a>
              </div>
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((f) => (
                <div key={f.title} className="bg-white p-6 rounded-2xl border border-gray-200 hover:border-indigo-300 shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
              ...
              <table className="w-full text-left">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-sm font-semibold text-foreground">RazorpayX</th>
                    <th className="px-6 py-4 text-sm font-semibold text-foreground">Open</th>
                    <th className="px-6 py-4 text-sm font-semibold text-foreground">Traditional bank portal</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  {comparisonRows.map((r) => (
                    <tr key={r.feature} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">{r.razorpayX ? <Check className="w-5 h-5 text-muted-foreground" /> : <X className="w-5 h-5 text-gray-300" />}</td>
                      <td className="px-6 py-4">{r.open ? <Check className="w-5 h-5 text-muted-foreground" /> : <X className="w-5 h-5 text-gray-300" />}</td>
                      <td className="px-6 py-4">{r.traditional ? <Check className="w-5 h-5 text-muted-foreground" /> : <X className="w-5 h-5 text-gray-300" />}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {useCases.map((u) => (
                <Link
                  key={u.href}
                  href={u.href}
                  className="block bg-gradient-to-br from-indigo-50 to-white p-6 rounded-2xl border border-indigo-100 hover:border-indigo-300 shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300"
                >
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Reconciliation in minutes</h3>
              ...
              <div>
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Forecast that's actually accurate</h3>
                <p className="text-muted-foreground">
              ...
              <div>
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">One source of truth</h3>
                <p className="text-muted-foreground">
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
            ...
            <div className="max-w-4xl space-y-4">
              {faqs.map((f) => (
                <details key={f.q} className="group bg-white border border-gray-200 rounded-2xl p-6 hover:border-indigo-300 transition-all duration-300">
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-3xl p-8 md:p-12 text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/start"
                  className="bg-white text-indigo-700 px-8 py-3 rounded-xl font-semibold shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300"
                >
                  Start Free
                </Link>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border border-white text-white hover:bg-white hover:text-indigo-700 px-8 py-3 rounded-xl font-medium transition-colors"
                >
                  Book a Demo
                </a>
              </div>
