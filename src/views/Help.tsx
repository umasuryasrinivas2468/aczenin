    ...
    <div className="min-h-screen">
      ...
      <main className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-center text-foreground mb-12">Help Center</h1>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Video Tutorials */}
            <div className="p-6 rounded-2xl border border-gray-200 bg-white shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-4">Learn how to use SMEPower through our detailed video guides</p>
            ...
            <div className="p-6 rounded-2xl border border-gray-200 bg-white shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-4">Detailed guides and documentation for all SMEPower features</p>
            ...
            <div className="p-6 rounded-2xl border border-gray-200 bg-white shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Live Support</h3>
              <p className="text-muted-foreground mb-4">Get help from our support team 24/7</p>
