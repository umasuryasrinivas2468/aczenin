        ...
        <main className="pt-24 pb-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-foreground">Partner Portal</span>
            </div>
          </div>

          {/* Welcome Section */}
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
            <div className="bg-gradient-to-r from-blue-50 to-smeteal-50 rounded-xl p-8">
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Resource Access */}
              <div className="bg-white p-6 rounded-2xl shadow-soft border border-gray-100 hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-foreground mb-2">Partner Resources</h3>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-soft border border-gray-100 hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-foreground mb-2">Partner Support</h3>
                <p className="text-gray-600 mb-4">Get dedicated support for your partnership needs and technical issues.</p>
                <button className="bg-smebank-600 hover:bg-smebank-700 text-white px-4 py-2 rounded-xl font-medium transition-colors">
                  Contact Support
                </button>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-soft border border-gray-100 hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
                ...
                <button className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-xl font-medium transition-colors">
                  View Analytics
                </button>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-soft border border-gray-100 hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-foreground mb-2">Training Center</h3>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-soft border border-gray-100 hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-foreground mb-2">New Opportunities</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-soft border border-gray-100">
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-smebank-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Lock className="w-8 h-8 text-smebank-600" />
                </div>
                <h1 className="text-2xl font-bold text-foreground mb-2">Partner Portal</h1>
                <p className="text-muted-foreground">Sign in to access your partner dashboard</p>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 text-sm rounded-xl border border-gray-200 bg-white outline-none transition-colors focus:border-smebank-300 focus:ring-2 focus:ring-smebank-100"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 text-sm rounded-xl border border-gray-200 bg-white outline-none transition-colors focus:border-smebank-300 focus:ring-2 focus:ring-smebank-100"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-smebank-600 to-smebank-700 text-white py-3 px-4 rounded-xl font-semibold shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 active:translate-y-0 hover:from-smebank-700 hover:to-smebank-800 transition-all duration-300"
                >
                  Sign In
                </button>
              </form>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-muted-foreground">
                  Need help? <a href="/contacts" className="text-smebank-600 hover:text-smebank-700 font-medium">Contact Support</a>
                </p>
              </div>
            </div>
          </div>
