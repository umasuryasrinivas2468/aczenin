...
const B2BPayments = () => {
  ...
  const features = [
    ...
    {
      icon: <TrendingUp className="h-10 w-10 text-smebank-600" />,
      ...
      badge: "Credit Ready",
      bgColor: "from-smebank-500 to-blue-500",
      iconBg: "bg-smebank-100"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="w-full md:w-[600px] mx-auto">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="flex-1 h-14 rounded-full border-2 border-smebank-200 px-6 text-lg focus:outline-none focus:ring-2 focus:ring-smebank-500 focus:border-transparent shadow-xl"
                  />
                  <Button
                    size="lg"
                    onClick={async (e) => {
                    ...
                    className="h-14 rounded-full bg-gradient-to-r from-smebank-600 to-blue-600 text-white px-8 text-lg font-semibold hover:opacity-90 transition-opacity shadow-xl hover:shadow-2xl"
                  >
                    Get Started
                  </Button>
                </div>
      ...
      <section className="py-24 bg-gradient-to-br from-smebank-50 via-smebank-50 to-pink-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <div className="inline-flex items-center bg-gradient-to-r from-smebank-100 to-smebank-100 rounded-full px-4 py-2 mb-6">
              <Layers className="h-4 w-4 text-smebank-600 mr-2" />
              <span className="text-sm font-medium bg-gradient-to-r from-smebank-600 to-smebank-600 bg-clip-text text-transparent">Enterprise Features</span>
            </div>
