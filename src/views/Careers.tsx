  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-24 pb-16">
        ...
        {/* Why Join Aczen */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 py-12 bg-gray-50 rounded-xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-foreground mb-4">Why Join Aczen?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-white p-6 rounded-2xl shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-foreground mb-4">Life at Aczen</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        {/* Call to Action */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-gradient-to-r from-red-500 to-red-600 rounded-xl text-white text-center">
          ...
          <a 
            ...
            className="inline-block bg-white text-red-600 hover:bg-red-50 font-bold py-4 px-12 rounded-xl uppercase tracking-wide shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300"
          >
            Apply Now
          </a>
        </section>
