      ...
      <main className="pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-muted-foreground">/</span>
            <span className="text-foreground">Aczen IDE</span>
          </div>
        </div>
            ...
            <div className="lg:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  className="bg-gradient-to-r from-green-600 to-green-700 text-white px-8 py-3 rounded-xl font-medium shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 flex items-center justify-center"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="border border-green-600 text-green-600 hover:bg-green-50 px-8 py-3 rounded-xl font-medium text-center"
                >
                  Schedule Demo
                </a>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Powerful Development Features</h2>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-3xl p-8 md:p-12">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4">Multi-Language Support</h2>
              <p className="text-lg text-muted-foreground">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
              {supportedLanguages.map((language, index) => (
                <div key={index} className="bg-white p-3 rounded-2xl shadow-soft text-center">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Extensible Platform</h2>
            <p className="text-lg text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-white p-4 rounded-2xl shadow-soft border">
                <div className="w-10 h-10 bg-green-100 rounded-xl mb-3"></div>
                <h3 className="font-bold text-foreground mb-1">{extension.name}</h3>
                <p className="text-sm text-muted-foreground mb-2">{extension.category}</p>
          ...
          <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-3xl p-8 md:p-12 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-white text-green-600 px-8 py-3 rounded-xl font-semibold shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center"
              >
                <Play className="w-4 h-4 mr-2" />
                Try Online IDE
              </a>
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="border border-white text-white hover:bg-white hover:text-green-600 px-8 py-3 rounded-xl font-medium transition-colors text-center"
              >
                Schedule Demo
              </a>
            </div>
