...
const CtaButton = ({
  ...
  const styles = {
    primary:
      "bg-gradient-to-r from-smebank-700 to-smeteal-600 text-white hover:shadow-soft hover:scale-[1.02]",
    ghost:
...
const SolutionTemplate = ({ content }: { content: SolutionContent }) => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-b from-smebank-50 via-smeteal-50/60 to-white pt-28 pb-20">
        <div className="container mx-auto px-4">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="rounded-3xl border border-white bg-white p-8 shadow-[0_30px_80px_-30px_rgba(15,40,70,0.45)]">
            ...
            {features.map((f) => {
              ...
              return (
                <motion.div
                  key={f.title}
                  variants={item}
                  className="group rounded-3xl border border-smebank-100/70 bg-white p-7 shadow-soft-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-soft-lg"
                >
